...
ActiveRecord::Schema.define(:version => 20150318215711) do
  ...
  add_index "historic_values", ["issue_id"], :name => "index_historic_values_on_issue_id"
  ...
  create_table "issues", :force => true do |t|
    ...
    t.integer  "ind_max"
    t.integer  "valor"
    t.integer  "valor_peso"
    t.string   "tipo_indicador",   :default => "Simetrico"
    t.integer  "alcance",          :default => 1
  end
  ...
  add_index "periodos", ["issue_id"], :name => "index_periodos_on_issue_id"
  ...
  create_table "projects", :force => true do |t|
    ...
    t.string   "cmi_versions"
    t.integer  "default_solicitud_assignee_id"
    t.boolean  "default_reporte_assign"
    t.integer  "perspectiva_cf"
    t.string   "cmi_show_trackers"
    t.boolean  "cmi_show_subprojects_tasks",    :default => false
    t.string   "cmi_show_trackers_to_docx"
    t.string   "cmi_trackers_con_peso"
  end
  ...
  create_table "reminder_configurations", :force => true do |t|
    t.string   "days"
    t.string   "issue_status_selector"
    t.string   "project_selector"
    t.boolean  "send_to_author"
    t.boolean  "send_to_assigned_to"
    t.boolean  "send_to_watcher"
    t.boolean  "send_to_custom_user"
    t.datetime "created_at",            :null => false
    t.datetime "updated_at",            :null => false
    t.string   "tracker_selector"
    t.boolean  "send_to_groups"
  end

  create_table "reminder_issue_statuses", :force => true do |t|
    t.integer "reminder_configuration_id"
    t.integer "issue_status_id"
  end

  create_table "reminder_projects", :force => true do |t|
    t.integer "reminder_configuration_id"
    t.integer "project_id"
  end

  create_table "reminder_trackers", :force => true do |t|
    t.integer "reminder_configuration_id"
